...
# keep children in ages 19-27  + natives (born in Israel and no immigration year information) + non ultraorthodox 
...
# calculate year of first "real" job: 1) more that 4 month during a calender year 2) yearly earnings more that 150% monthly average wage 3) after graduation year (or after age 21 if there is no graduation year)
