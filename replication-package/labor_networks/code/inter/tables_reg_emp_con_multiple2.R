...
# No college
table_temp <- run.reg.emp.con.multiple2(df_reg[education == 0])
...
# Some college
table_temp <- run.reg.emp.con.multiple2(df_reg[education == 1])
...
table6 <- prepare.reg.emp.con.table.multiple2(table6)
table7 <- prepare.reg.emp.con.table.multiple2(table7)
